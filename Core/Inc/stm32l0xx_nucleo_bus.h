...
#define BUS_I2C1_SCL_GPIO_PORT GPIOA
#define BUS_I2C1_SCL_GPIO_AF GPIO_AF6_I2C1
#define BUS_I2C1_SCL_GPIO_CLK_ENABLE() __HAL_RCC_GPIOA_CLK_ENABLE()
#define BUS_I2C1_SCL_GPIO_CLK_DISABLE() __HAL_RCC_GPIOA_CLK_DISABLE()
#define BUS_I2C1_SCL_GPIO_PIN GPIO_PIN_9
#define BUS_I2C1_SDA_GPIO_PIN GPIO_PIN_10
#define BUS_I2C1_SDA_GPIO_CLK_DISABLE() __HAL_RCC_GPIOA_CLK_DISABLE()
#define BUS_I2C1_SDA_GPIO_PORT GPIOA
#define BUS_I2C1_SDA_GPIO_AF GPIO_AF6_I2C1
